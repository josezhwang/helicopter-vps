  ...
  if (view === 'room' && activeRoom) {
    return (
      <RoomLobby
        ...
        onStart={() => setRooms((current) => current.map((room) => room.id === activeRoom.id ? { ...room, status: 'live' } : room))}
      />
    )
  }
